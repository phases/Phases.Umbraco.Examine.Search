...
using Phases.Umb.Examine.Search.Extension.Indexing;
...
namespace Phases.Umb.Examine.Search.Extension.Services
{
    public class SuggestionService : ISuggestionService
    {
        ...
        public IOrderedEnumerable<Suggestion> SuggestionData(string word, int numberOfSuggestions = 10, string culture = null)
        {
            ...
            string fieldName = Internals.FieldName;
            if (culture != null)
            {
                fieldName += $"_{culture}";
            }
            ...
            var fieldConfig = new IndexWriterConfig(LuceneVersion.LUCENE_48, analyser);
            var nodeNameConfig = new IndexWriterConfig(LuceneVersion.LUCENE_48, analyser);
